...
import { Home, LayoutDashboard, TrendingUp, TrendingDown, Sparkles, RepeatIcon, LogOut, HandCoins, Landmark, ArrowUpDown, ShieldCheck, CalendarDays, PiggyBank, CreditCard } from 'lucide-react'
...
const links = [
  ...
  { to: '/deudas',      label: 'Mis deudas',   icon: CreditCard },
